...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<User> updateUser(@PathVariable Integer id, @RequestBody Map<String, String> updates) {
        String username = updates.get("username");
        String bio = updates.get("bio");
        
        User updatedUser = userService.updateUser(id, username, bio);
